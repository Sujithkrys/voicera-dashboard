...
const NodeWrapper = ({ children, title, icon: Icon, color }: any) => (
  <div className="bg-background rounded-xl shadow-sm border border-border overflow-hidden w-[260px] font-sans">
    <div className={`px-4 py-3 flex items-center gap-2 border-b border-border ${color}`}>
  ...
  return (
    <>
      <NodeWrapper title="Chat Input" icon={MessageSquare} color="bg-blue-50">
        <div className="text-[11px] text-muted-foreground">Receives user messages from the chat widget.</div>
      </NodeWrapper>
  ...
  return (
    <>
      ...
      <NodeWrapper title="Prompt Template" icon={Settings2} color="bg-purple-50">
        <textarea 
          className="w-full text-[12px] p-2 border border-border rounded-md min-h-[80px] resize-none focus:outline-none focus:ring-1 focus:ring-purple-500"
    ...
    <>
      ...
      <NodeWrapper title="Groq LLM" icon={Cpu} color="bg-green-50">
        ...
        <div>
          ...
          <input type="password" placeholder="gsk_..." className="w-full text-[12px] p-1.5 border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-green-500" />
        </div>
      </NodeWrapper>
  ...
  return (
    <>
      ...
      <NodeWrapper title="Chat Output" icon={FileOutput} color="bg-orange-50">
        <div className="text-[11px] text-muted-foreground">Sends the AI response back to the widget.</div>
      </NodeWrapper>
    </>
  );
};
  ...
  return (
    <>
      ...
      <NodeWrapper title="Gmail" icon={Mail} color="bg-red-50">
        <div className="text-[11px] text-muted-foreground">Send or read emails from Gmail.</div>
      </NodeWrapper>
  ...
  return (
    <>
      ...
      <NodeWrapper title="Google Sheets" icon={Table} color="bg-emerald-50">
        <div className="text-[11px] text-muted-foreground">Read or append rows to Sheets.</div>
      </NodeWrapper>
  ...
  return (
    <>
      ...
      <NodeWrapper title="Google Docs" icon={FileText} color="bg-blue-50">
        <div className="text-[11px] text-muted-foreground">Generate or read documents.</div>
      </NodeWrapper>
      <Handle type="source" position={Position.Right} className="w-3 h-3 bg-blue-500 border-2 border-white" />
    </>
  );
  ...
  return (
    <>
      ...
      <NodeWrapper title="Google Calendar" icon={Calendar} color="bg-teal-50">
        <div className="text-[11px] text-muted-foreground">Schedule or list events.</div>
      </NodeWrapper>
...
export const NotionNode = ({ data }: any) => {
  return (
    <>
      ...
      <NodeWrapper title="Notion" icon={BookOpen} color="bg-secondary">
        <div className="text-[11px] text-muted-foreground">Update databases and pages.</div>
      </NodeWrapper>
